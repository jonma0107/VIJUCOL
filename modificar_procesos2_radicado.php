...
<?php
$radicado1 = $_POST['radicado1'];



// Comprobar Registro

$busqueda= $mysqli->query("SELECT * FROM procesos WHERE radicado='$radicado1'");
if(mysqli_num_rows($busqueda)>0)
{
    $query = "select * from procesos where radicado = '$radicado1'";
...
echo "
<br><br><br>
<form name='form1' method='post' action='modificar_procesos3_radicado.php'>
<br>
