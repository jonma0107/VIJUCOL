...
<title>Consulta de un Proceso - RAMA JUDICIAL</title>
<style type="text/css">
...
$busqueda= $mysqli->query("SELECT ccdemandante FROM procesos WHERE ccdemandante='$cedula1'");
if(mysqli_num_rows($busqueda)>0)
{
      $query = "select * from procesos where ccdemandante = '$cedula1'";
...
echo "
<br><br><br>
<form name='form1' method='post' action='consulta_proceso_dte.php'>
<br>
<div class='datagrid'><table align='center'>
<thead><tr><th colspan='6' rowspan='1' align='center'>Consultar Proceso</th></tr></thead>

<tfoot><tr><td colspan='6'><div id='paging' align='center'><br><input value='Nueva consulta' onclick='valida_envia()' type='submit' class='classboton' style=cursor:pointer;><br><br></div></tr></tfoot>
<tbody>
<tr class='alt'><td align='center'>Cedula</td><td><input  name='cedula' maxlength='12' onkeypress='return justNumbers(event);' required value='".$registro['ccdemandante']."' readonly></td></tr>
...
<tr><td align='center'>Nombre Juzgado</td><td><input name='juzgado' required value='".$registro['juzgado']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>
<tr><td align='center'>Tipo de Proceso</td><td><input name='proceso' required value='".$registro['proceso']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>

<tr><td align='center'>Nombre y Apellido Demandante</td><td><input name='demandante' required value='".$registro['demandante']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>



<tr><td align='center'>Nombres y Apellidos Demandado</td><td><input name='demandado' required value='".$registro['demandado']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>

<tr><td align='center'>Cedula Demandado</td><td><input name='ccdemandado' required value='".$registro['ccdemandado']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>

<tr><td align='center'>Etapa Procesal</td><td><input name='etapa' required value='".$registro['etapa']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>

<tr><td align='center'>Estado </td><td><input name='estado' required value='".$registro['estado']."' placeholder='Ingresa Nombre Completo' readonly></td></tr>
</tr>


<tr><td align='center'>Observacion </td><td><textarea name='observacion'  style='width:400px; height:100px;' required value='".$registro['observacion']."' placeholder='Observaciones extra' readonly></textarea></td></tr>
</tbody>
</table></div>
</form>
</center>
