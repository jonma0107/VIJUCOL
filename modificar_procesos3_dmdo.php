...
$sSQL ="UPDATE procesos SET juzgado='$juzgado',proceso='$proceso',demandante='$demandante',demandado='$demandado',ccdemandado=$ccdemandado,etapa='$etapa',estado='$estado' WHERE ccdemandado='$ccdemandado'"; 
$mysqli->query($sSQL);
