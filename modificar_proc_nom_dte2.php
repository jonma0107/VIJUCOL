...
$busqueda= $mysqli->query("SELECT demandante FROM procesos WHERE demandante='$nombre'");
if(mysqli_num_rows($busqueda)>0)
{
    $query = "select * from procesos where demandante = '$nombre'";
...
<nav>
       <ul class="nav">
         <li><a href="menu.php">Inicio</a></li><!--OK-->
...
echo "
<br><br><br>
<form name='form1' method='post' action='modificar_proc_nom_dte3.php'>
<br>
