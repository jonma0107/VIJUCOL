...
$busqueda= $mysqli->query("SELECT ccdemandado FROM procesos WHERE ccdemandado='$cedula1'");
if(mysqli_num_rows($busqueda)>0)
{
    $query = "select * from procesos where ccdemandado = '$cedula1'";
...
<nav>
	...
	<section>
		<div id="mod_proc_dmdo" align="center">

<?php
echo "
<br><br><br>
<form name='form1' method='post' action='modificar_procesos3_dmdo.php'>
<br>
...
<tr><td align='center'>Numero de Radicado</td><td><input name='radicado' required value='".$registro['radicado']."' placeholder='Ingresa Nombre Completo'></td></tr>
